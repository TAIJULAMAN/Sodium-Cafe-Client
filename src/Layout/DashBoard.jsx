    ...
    <div className="drawer-side bg-[#D1A054]">
      ...
      <ul className="menu p-4 w-80">
         ...
         <li>
          ...
          <li>
            <NavLink to="/menu"><FaBookOpen></FaBookOpen> Menu</NavLink>
          </li>
          <li>
            <NavLink to="/order/salad"><FaShoppingBasket></FaShoppingBasket>Order Page</NavLink>
          </li>
        </ul>
    </div>
  </div>
